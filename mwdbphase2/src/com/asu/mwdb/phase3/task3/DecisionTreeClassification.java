...
public class DecisionTreeClassification {
	...
	public static void dtClassifyMatlab(MatlabProxy proxy, String databaseDirectory, String gesturesLabels, File[] fileNames, List<String> testDataFiles) throws MatlabInvocationException, IOException {
	...
	public static void dtClassify(String testDatFile, String trainingDataFile) throws FileFormatException, IOException {
